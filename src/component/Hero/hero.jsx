...
const Hero = () => {
  return (
    <section>
      <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[650px] realative">
        <div className="flex flex-col justify-center py-14 md:py-0 relative z-10">
          <div className="text-center md:text-left space-y-6 lg:max-w-[400px]">
            <motion.h1
              ...
              initial="hidden"
              animate="visible"
              className="text-5xl lg:text-6xl font-bold landing-relaxed xl:leading-loose font"
            >
              Healthy
              <br />
